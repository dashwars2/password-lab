...
with q1:
    st.markdown('<div class="quick-card"><div class="qtitle">WHAT WE CHECK</div><div class="qvalue">4 core signals</div><div class="qsub">Length · variety · patterns · repetition</div></div>',unsafe_allow_html=True)
with q2:
    st.markdown('<div class="quick-card"><div class="qtitle">SIMULATION MODE</div><div class="qvalue">Tiny + local</div><div class="qsub">No accounts, websites, or networks</div></div>',unsafe_allow_html=True)
with q3:
    st.markdown('<div class="quick-card"><div class="qtitle">BEST DEMO</div><div class="qvalue">cat123 → analyse</div><div class="qsub">Then compare it with a longer example</div></div>',unsafe_allow_html=True)

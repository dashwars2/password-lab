...
<div class="feature-dashboard">
  ...
  <div class="feature-grid">
    <div class="feature-card"><div class="feature-icon">🧠</div><div class="feature-title">DISSECT IT</div><div class="feature-sub">Analyse length, character variety and predictable patterns.</div></div>
    <div class="feature-card"><div class="feature-icon">⚡</div><div class="feature-title">RUN SIMULATION</div><div class="feature-sub">Run the safe local guessing demonstration.</div></div>
    <div class="feature-card"><div class="feature-icon">🥊</div><div class="feature-title">PASSWORD BATTLE</div><div class="feature-sub">Compare two fictional passwords side by side.</div></div>
    <div class="feature-card"><div class="feature-icon">💀</div><div class="feature-title">SHOW THE DAMAGE</div><div class="feature-sub">See why the lab gave a password its score.</div></div>
  </div>
  <div class="kpi-row">
    <div class="kpi"><div class="kpi-label">MODE</div><div class="kpi-value">LOCAL</div></div>
    <div class="kpi"><div class="kpi-label">NETWORK</div><div class="kpi-value">OFFLINE</div></div>
    <div class="kpi"><div class="kpi-label">ACCOUNTS</div><div class="kpi-value">NONE</div></div>
    <div class="kpi"><div class="kpi-label">PURPOSE</div><div class="kpi-value">LEARN</div></div>
  </div>
</div>
""", unsafe_allow_html=True)
